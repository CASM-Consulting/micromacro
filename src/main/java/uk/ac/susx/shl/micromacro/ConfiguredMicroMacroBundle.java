...
public class ConfiguredMicroMacroBundle implements ConfiguredBundle<MicroMacroConfiguration> {
    private static final Logger LOG = Logger.getLogger(ConfiguredMicroMacroBundle.class.getName());
